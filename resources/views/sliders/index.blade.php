...
@section('content')
                    ...
                    <div class="page-title-box">
                        <div class="btn-group pull-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                ...
                                <li class="breadcrumb-item"><a href="#">Page Sliders</a></li>
                                <li class="breadcrumb-item active">Page Sliders</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Page Sliders</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <button type="button" id="add_button" data-toggle="modal" class="btn btn-success waves-effect waves-light custom-success-btn">
                        <span class="btn-label"><i class="mdi mdi-database-plus"></i></span>Add New Slider
                    </button>
    ...
    @include('sliders.create_update_model')
@endsection
...
{{--    <script src="{{ URL::asset('assets/libs/jquery-mockjax/jquery-mockjax.min.js')}}"></script>--}}
    ...
    <script src="{{ URL::asset('admin/slider_pages.js')}}"></script>

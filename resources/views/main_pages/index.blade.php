...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <button type="button" id="add_button" data-toggle="modal" class="btn btn-success waves-effect waves-light custom-success-btn">
                        <span class="btn-label"><i class="mdi mdi-database-plus"></i></span>Add New Page
                    </button>
    ...
    @include('main_pages.create_update_model')
@endsection
...
{{--    <script src="{{ URL::asset('assets/libs/jquery-mockjax/jquery-mockjax.min.js')}}"></script>--}}
    ...
    <script src="{{ URL::asset('admin/main_pages.js')}}"></script>

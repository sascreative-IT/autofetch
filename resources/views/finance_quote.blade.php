...
<body>
	...
	<div class="breadcrumb-main">
		<h1 class="title black">Car loan repayment calculator NZ</h1>
	...
	<section class="finance-quote-sec">
		<div class="inner">
			<div class="row row-clr">
				<div class="col-sm-12">
					<h2 class="title black">Get your car loan quote in seconds</h2>
					...
					<div class="quote-cal">
                        <form id="finance_quote_form" method="post" action="{{url('finance-quote-form')}}" >
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<input type="email" name="user_email" id="user_email" class="form-control form-control-lg" placeholder="E mail">
								</div>
                                
                                <div class="form-group col-md-6">
									<input type="tel" name="phone_number" id="phone_number" class="form-control form-control-lg" placeholder="Phone number">
							...
							<div class="tab-content" id="pills-tabContent">
								<div class="tab-pane fade show active" id="pills-weekly" role="tabpanel" aria-labelledby="pills-weekly-tab">
									<div class="box">
										...
										<h2 class="price" id="total_price_week">$1135</h2>
								...
								<div class="tab-pane fade" id="pills-fortnighty" role="tabpanel" aria-labelledby="pills-fortnighty-tab">
									<div class="box">
										...
										<h2 class="price" id="total_price_fortnight">$2270</h2>
								...
								<div class="tab-pane fade" id="pills-monthly" role="tabpanel" aria-labelledby="pills-monthly-tab">
									<div class="box">
										...
										<h2 class="price" id="total_price_month">$4540</h2>
										<h3 class="title2 loan_amount_holder">For A $50,000 Loan</h3>
									</div>
								</div>
							</div>
...
<script src="{{url('admin/form_calculate.js?2333')}}"></script>
<script>
